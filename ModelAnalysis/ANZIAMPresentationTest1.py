...
input_list.append({"vegfdudtcoeff": 0.1, "vegfdiffusioncoeff": 200, "vegfdecaycoeff" : 10.0, "vegfcreationcoeff": 8.3, "vegfconsumptioncoeff": 1.0, "vegfinitialvalue": 0.1, "vegfboundaryvalue": args.sourceterm, "output_directory": "ModelWithPdes2DTestAnalyticalSeedSource/Test1/ModelWithPdes2DTest1PdeSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "output_directory_analyticalvegf": "ModelWithPdes2DTestAnalyticalSeedSource/Test1/ModelWithPdes2DTest1AnalyticalSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "maxsproutingrate": 0.2, "sigma": 1e-5, "chi": 1e-2, "omegap": 1e-3, "omegaa": 1e-1, "seed": args.valuerandomseed, "testnb": 1})
