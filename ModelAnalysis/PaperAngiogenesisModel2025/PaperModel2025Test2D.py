...
# Analytical Approx Pde
input_list.append({"vegfdudtcoeff": 0.1, "vegfdiffusioncoeff": 200, "vegfdecaycoeff" : 10.0, "vegfcreationcoeff": 8.3, "vegfconsumptioncoeff": 1.0, "vegfinitialvalue": 0.1, "vegfboundaryvalue": args.sourceterm, "vegfconstantbackground": 0.1, "sigma": 1e-5, "chi": 1e-2, "omegap": 1e-3, "omegaa": 1e-1, "maxsproutingrate": 0.2, "psproutfunctiontestnb": 1, "time": 300, "seed": args.valuerandomseed, "output_directory": "PaperModel2025Analysis2D/CoupledModel2DPdeSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "output_directory_analyticalapproxvegf": "PaperAngiogenesisModel2025/PaperModel2025Analysis2D/CoupledModel2DAnalyticalApproxPde/CoupledModel2DAnalyticalApproxPdeSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "output_directory_vegfconstant": "PaperAngiogenesisModel2025/PaperModel2025Analysis2D/CoupledModel2DConstant/CoupledModel2DConstantSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb)})

# Constant: problem for random seed 3
# input_list.append({"vegfdudtcoeff": 0.1, "vegfdiffusioncoeff": 200, "vegfdecaycoeff" : 10.0, "vegfcreationcoeff": 8.3, "vegfconsumptioncoeff": 1.0, "vegfinitialvalue": 0.1, "vegfboundaryvalue": 0.1, "vegfconstantbackground": args.sourceterm, "sigma": 1e-5, "chi": 1e-2, "omegap": 1e-3, "omegaa": 1e-1, "maxsproutingrate": 0.2, "psproutfunctiontestnb": 1, "time": 300, "seed": args.valuerandomseed, "output_directory": "PaperModel2025Analysis2D/CoupledModel2DPdeSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "output_directory_analyticalapproxvegf": "PaperAngiogenesisModel2025/PaperModel2025Analysis2D/CoupledModel2DAnalyticalApproxPde/CoupledModel2DAnalyticalApproxPdeSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb), "output_directory_vegfconstant": "PaperAngiogenesisModel2025/PaperModel2025Analysis2D/CoupledModel2DConstant/CoupledModel2DConstantSeed" + str(RandomSeedNb) + "Source" + str(SourceTermNb)})
