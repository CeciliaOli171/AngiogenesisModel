...
do
    ...
    do
        echo $i $j
        python3 /Users/coli171/Chaste/Source/projects/AngiogenesisModel/ModelAnalysis/PaperAngiogenesisModel2025/PaperModel2025Test3D.py -valuerandomseed $i -sourceterm $j 
    done
done 